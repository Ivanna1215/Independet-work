...
function data() {
    ...
    if ((year % 400 === 0 || year % 4 === 0 && year % 100 > 0) && day === 28 && month === 2) {
        ...
        day -= 30;
        month += 1;
        alert(`Your result N4 ${day}.${month}.${year}`);
    } 
    else if (month === 1 && day > 31 || month === 3 && day > 31 || month === 5 && day > 31 || month === 7 && day > 31 || month === 8 && day > 31 || month === 10 && day > 31) {
        ...
        day -= 29;
        month += 1;
        alert(`Your result N5 ${day}.${month}.${year}`);
    } 
    else if (month === 4 && day > 30 || month === 6 && day > 30 || month === 9 && day > 30 || month === 11 && day > 30)   {
       
        alert(`Your result N5a you entered an incorrect code`);
    } 
        ...
        month -= 11;
        year += 1;
        alert(`Your result N6 ${day}.${month}.${year}`)
    }
    else if (month === 12 && day > 31) {
